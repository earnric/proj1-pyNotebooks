...
#         print "Plot Z..."
#         titleStr = "Z @ z = %.3lf" % z + "\nVol ave"
#         pp.sph.image(s.g,qty="metal",width=boxsizestring,cmap="YlOrRd", denoise=True ,av_z=True, log=True, vmin=1e-7,
...
#         pp.sph.image(s.g,qty="pzf",width=boxsizestring,cmap="YlOrRd", denoise=True ,av_z=True, log=True, vmin=1e-7,
...
#         pp.sph.image(s.g,qty="ompgf",width=boxsizestring,cmap="YlOrRd", denoise=True ,av_z=True, log=True, vmin=1e-7,
