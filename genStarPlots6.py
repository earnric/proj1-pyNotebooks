...
def outputImages(z,i,snBlast):
    ...
    with pynbody.transformation.translate(snBlast,coords):
        try:
            fileOut="imgC_Z-z=%.1lf-%i.png"% (z,i)
            ...
            fileOut="imgC_PGF-z=%.1lf-%i.png"% (z,i)
            ...
            fileOut="imgC_PZ-z=%.1lf-%i.png"% (z,i)
            ...
            fileOut="imgC_Density-z=%.1lf-%i.png"% (z,i)
            ...
            fileOut="imgC_Temp-z=%.1lf-%i.png"% (z,i)
            ...
            fileOut="imgC_vt-z=%.1lf-%i.png"% (z,i)
